...
function DistributeBalance({actors}: DistributeBalanceParameters) {
  ...
  const submitDistributeBalance = async() => {
    if (tokenIdentifierError !== null) {
      throw tokenIdentifierError;
    }
    if (amountError !== null){
      throw amountError;
    };
    if (tokenCanisterError !== null){
      throw tokenCanisterError;
    };
    if (tokenRecipientError !== null){
      throw tokenRecipientError;
    };
  ...
  return (
    ...
    <div className="flex flex-row">
      ...
      <button disabled={tokenIdentifierError!==null || amountError!==null || tokenCanisterError!==null || tokenRecipientError!==null} onClick={submitDistributeBalance} className="self-end ml-5 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-lg w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        Submit proposal
      </button>
    </div>
    </>
