...
call dip20.balanceOf(cycles_dispenser);
assert _ == (0 : nat);

// Test that the command fails if the cycles_dispenser does not have any dip20 token
...
call dip20.transfer(cycles_dispenser, 1_000_000_000);
