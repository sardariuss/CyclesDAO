...
dfx canister call cyclesDAO configure '(variant {AddAllowList = record { balance_threshold = 1_000_000; canister = principal "'${TO_POWER_UP_1_ID}'"; pull_authorized = false; }})'
dfx canister call cyclesDAO configure '(variant {AddAllowList = record { balance_threshold = 2_000_000; canister = principal "'${TO_POWER_UP_2_ID}'"; pull_authorized = true; }})'