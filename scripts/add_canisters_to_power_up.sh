...
export CYCLES_DISPENSER_PRINCIPAL=$(dfx canister id cyclesDispenser)

dfx deploy toPowerUpFactory --argument='(principal "'${CYCLES_DISPENSER_PRINCIPAL}'")'
...
dfx canister call cyclesDispenser configure '(variant {AddAllowList = record { balance_threshold = 8_000_000_000_000; balance_target = 10_000_000_000_000; canister = principal '${TO_POWER_UP_1_PRINCIPAL}'; pull_authorized = true; }})'
...
dfx canister call cyclesDispenser configure '(variant {AddAllowList = record { balance_threshold = 5_000_000_000_000; balance_target = 8_000_000_000_000; canister = principal '${TO_POWER_UP_2_PRINCIPAL}'; pull_authorized = true; }})'
...
dfx canister call cyclesDispenser configure '(variant {AddAllowList = record { balance_threshold = 2_000_000_000_000; balance_target = 5_000_000_000_000; canister = principal '${TO_POWER_UP_3_PRINCIPAL}'; pull_authorized = true; }})'
...
dfx canister call cyclesDispenser configure '(variant {AddAllowList = record { balance_threshold = 8_000_000_000_000; balance_target = 12_000_000_000_000; canister = principal '${TO_POWER_UP_4_PRINCIPAL}'; pull_authorized = false; }})'
...
dfx canister call cyclesDispenser configure '(variant {AddAllowList = record { balance_threshold = 1_000_000_000_000; balance_target = 2_000_000_000_000; canister = principal '${TO_POWER_UP_5_PRINCIPAL}'; pull_authorized = false; }})'
